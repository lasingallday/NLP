...
# column A is the column string checked againstself. it will be switched to the project need statement column.
df['books_flag'] = np.where(df['A'].str.contains('books'),'True','False')
df['classroom_flag'] = np.where(df['A'].str.contains('classroom'),'True','False')
